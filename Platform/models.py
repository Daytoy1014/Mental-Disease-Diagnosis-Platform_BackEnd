...
class Data(models.Model):
    ...
    model = models.CharField(Model, on_delete=models.CASCADE, verbose_name='数据集关联模型')
...
class DiagnosisMission(models.Model):
    ...
    patient_name = models.CharField(verbose_name='患者姓名', max_length=255)
    researcherEstablish = models.CharField(verbose_name='是否为科研人员创建', max_length=10)
    whetherPublic = models.CharField(verbose_name='是否通知病人', max_length=10)
    ...
    data = models.CharField(Data, on_delete=models.CASCADE, verbose_name='任务数据集')
    model = models.CharField(Model, on_delete=models.CASCADE, verbose_name='任务模型')
    scene = models.CharField(verbose_name='任务应用场景', max_length=255)
